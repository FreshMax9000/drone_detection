...
def get_net(config_path: str, weights_path: str):
    return load_net(c_char_p(config_path.encode("utf-8")), c_char_p(weights_path.encode("utf-8")), 0)

def get_meta(meta_path: str):
    return load_meta(c_char_p(meta_path.encode("utf-8")))
...
if __name__ == "__main__":
    ...
    #print r[:10]
    net = load_net(c_char_p(b"./cfg/yolov3.cfg"), c_char_p(b"./yolov3.weights"), 0)
